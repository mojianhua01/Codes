...
hold on;
grid on;
plot(SNR_vector,C_fb_0, 'or--', 'Linewidth',1.2);
plot(SNR_vector,C_fb_1, 'sr--', 'Linewidth',1.2);
plot(SNR_vector,C_fb_2, 'dr--', 'Linewidth',1.2);
plot(SNR_vector,C_fb_3, '^r--', 'Linewidth',1.2);
plot(SNR_vector,C_fb_4, 'vr--', 'Linewidth',1.2);
...
plot(SNR_vector,C_CSIT - C_fb_0, 'or--', 'Linewidth',1.2);
hold on;
grid on;
plot(SNR_vector,C_CSIT - C_fb_1, 'sr--', 'Linewidth',1.2);
plot(SNR_vector,C_CSIT - C_fb_2, 'dr--', 'Linewidth',1.2);
plot(SNR_vector,C_CSIT - C_fb_3, '^r--', 'Linewidth',1.2);
plot(SNR_vector,C_CSIT - C_fb_4, 'vr--', 'Linewidth',1.2);
plot(SNR_vector,C_CSIT - C_No_CSIT, 'xk-.', 'Linewidth',1.2);
